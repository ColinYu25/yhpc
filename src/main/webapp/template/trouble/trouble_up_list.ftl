...
<#if dept?exists>
	<#if dept.type?if_exists=='0'>
		<#assign letter='已接收隐患列表'>
		<#assign url='loadTroubleUp.xhtml'>
	<#elseif  dept.type?if_exists=='1'>
		<#assign letter='已接收未回复隐患列表'>
		<#assign url='loadTroubleUpNotBack.xhtml'>
	<#elseif  dept.type?if_exists=='2'>
		<#assign letter='已接收已回复隐患列表'>
		<#assign url='loadTroubleUpBack.xhtml'>
	<#elseif  dept.type?if_exists=='3'>
		<#assign letter='已接收未反馈隐患列表'>
		<#assign url='loadTroubleUpNotResult.xhtml'>
	<#elseif  dept.type?if_exists=='4'>
		<#assign letter='已接收已反馈隐患列表'>
		<#assign url='loadTroubleUpResult.xhtml'>
	</#if>
</#if>
