...
<table cellspacing="0" cellpadding="0" class="table_input">
  <tr>
    <td width="7%" rowSpan="3"  style="background:#F0F0F0;color:#333;" align="center"><strong>接<br>收<br>部<br>门</strong></td>
...
<input type="hidden" name="dept.troubleCopyType" value="4" id="troubleCopyType"/>
</form>
</#escape>
<@fkMacros.pageFooter />