...
<table width="90%" border="0" height="20" cellspacing="0" align="center" cellpadding="0">
  <tr>
   <tr><td align="center" colspan="${areas?size+3}"><br><strong style="font-size:23px;line-height:30px;">安全生产隐患接收回复表</strong></td></tr>
  </tr>
  <tr><td align="center" style="font-size:12pt;line-height:25px;">抄告编号：${trouble.troubleNo}　　　　　　　　　　　　　　　　　　　　回复时间：${dept.submitTime?date}</td></tr>
</table>
<table width="700" cellspacing="1" cellpadding="0" border="0" align="center"  class="table_list3">
  <tr>
    <td width="9%" rowSpan="3"  align="center"><strong>接<br>收<br>部<br>门</strong></td>
  ...
  <tr height="120">
  	<td align="center"><strong>接收时间</strong></td>
    <td colSpan="1">${dept.receiptTime?date}</td>
