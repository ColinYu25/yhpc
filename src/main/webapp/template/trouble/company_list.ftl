...
<div class="menu">
  	...
  	<li id="img_vary"><a href="#" class="b8" onClick="loadNote('createTroubleInit.xhtml?company.id')"><b>抄告</b></a></li>
  	<#if userDetail.secondArea!=0><li id="img_report"><a href="#" class="b7" onClick="loadNote('createTroubleInitByDownOrUp.xhtml?company.id')"><b>上报</b></a></li></#if>
  	<#if userDetail.secondArea==0><li id="img_amend"><a href="#" class="b2" onClick="loadNote('createTroubleInitByDownOrUp.xhtml?company.id')"><b>下达</b></a></li></#if>
