...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	<th width="100%" height="22">安全生产隐患接收回复表</th>
  </tr>
</table>
<div class="menu">
...
<table cellspacing="0" cellpadding="0" class="table_input">
  <tr>
    <td width="7%" rowSpan="2"  style="background:#F0F0F0;color:#333;" align="center"><strong>反馈<br>部门</strong></td>
  ...
  <tr>
  	<td  colSpan="2" style="background:#F0F0F0;color:#333;" align="center"><strong>处理结果</strong>
    <td colSpan="5">
    <textarea id="description" name="dept.description" rows="17" cols="70">${dept.description}</textarea>
...
<input type="hidden" name="dept.troubleCopyType" value="5" id="troubleCopyType"/>
</form>
</#escape>
<@fkMacros.pageFooter />