...
<table width="560" height="36" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="35" align="center" valign="middle" class="h4">生产经营单位安全生产基本情况表</td>
  </tr>
  <tr>
...
<table width="560" border="0" cellpadding="0" cellspacing="0" align="center" class="main_table">
  <tr>
    <td align="center">
...
<div id="c02" class="hidden">
  <table width="560" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
      ...
      <td width="67" align="center" class="td4"><input name="mainPrincipal" size="8" value="${(securityManage.mainPrincipal)?if_exists}" type="text" class="noborder" entity="DaSecurityManage"/></td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="50" align="center" class="td4">证书号</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      ...
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="44" align="center" class="td4">有效期</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
    ...
    <tr>
      ...
      <td width="1" height="28" align="center" bgcolor="DBDBDB"></td>
      <td width="67" align="center" class="td4"><input name="securityPrincipal" size="8" value="${(securityManage.securityPrincipal)?if_exists}" type="text" class="noborder" entity="DaSecurityManage"/></td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="50" align="center" class="td4">证书号</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
  ...
  <table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="1" height="28" align="center" bgcolor="DBDBDB"></td>
      <td width="67" align="center" class="td4" id="category">&nbsp;</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="50" align="center" class="td4">证书号</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="146" align="center" class="td4" id="licence">&nbsp;</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
      <td width="44" align="center" class="td4">有效期</td>
      <td width="1" align="center" bgcolor="DBDBDB"></td>
  ...
  <iframe id="iframe_nbxzzf" align="center" width="100%" height="28" frameborder=0 scrolling=NO src="../companyPunishment/loadCompanyPunishmentsinfo.xhtml?company.id=${company.id}"></iframe>
        <table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="1" colspan="8" align="center" bgcolor="DBDBDB"></td>
          </tr>
          <tr>
            <td width="84" rowspan="3" align="center" bgcolor="f4f4f4" class="td1">事故情况</td>
            <td height="28" align="center" class="td3" colspan="7">
          ...
          <tr>
            <td height="28" align="center" class="td3">一年内工伤人数</td>
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center">${injuryManage.insuredNum} 人</td>
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center" class="td3">工伤率</td>
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center">${injuryManage.injuryNum} ‰&nbsp;</td>
          </tr>
          <tr>
            <td height="1" colspan="8" align="center" bgcolor="DBDBDB"></td>
          </tr>
          <tr>
            <td width="84" rowspan="3" align="center" bgcolor="f4f4f4" class="td1">信用管理</td>
            <td height="28" align="center" class="td3">信用等级</td>
            <td width="0" align="center" bgcolor="DBDBDB"></td>
            <td align="center">${creditManage.grade}&nbsp;</td>
            <td width="0" align="center" bgcolor="DBDBDB"></td>
            <td align="center" class="td3">承诺书</td>
            <td width="0" align="center" bgcolor="DBDBDB"></td>
            <td align="center">
            	<#if creditManage?? && creditManage.promise??><a href="${(creditManage.promise)?if_exists}"><img src="${resourcePath}/images/download.gif" width="16" height="16" style="cursor:pointer;" title="点击下载"/></a><#else></#if>
            </td>
          </tr>
          <tr>
            <td height="1" colspan="7" align="center" bgcolor="DBDBDB"></td>
          ...
          <tr>
            ...
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center">
            	<#if creditManage?? && creditManage.publicity??><a href="${(creditManage.publicity)?if_exists}"><img src="${resourcePath}/images/download.gif" width="16" height="16" style="cursor:pointer;" title="点击下载"/></a><#else></#if>
            </td>
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center" class="td3">年度报告</td>
            <td width="1" align="center" bgcolor="DBDBDB"></td>
            <td align="center">
            	<#if creditManage?? && creditManage.yearReport??><a href="${(creditManage.yearReport)?if_exists}"><img src="${resourcePath}/images/download.gif" width="16" height="16" style="cursor:pointer;" title="点击下载"/></a><#else></#if>
            </td>
          </tr>
        </table>
</div>
...
<div id="uploadImageDiv" style="position:absolute; width:300px; top:600px; text-align:center; background:#FFF7EE; left:500px; display:none; border-top:#f4f4f4 5px solid; border-bottom:#f4f4f4 5px solid; border-left:#CCC 5px solid; border-right:#CCC 5px solid; left: 12px; top: 13px; font-size:13px;">
...
<input type="hidden" name="daImageFile.daCompany.id" value="${company.id}" />
 <table width="92%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" align="left" valign="bottom">请选择要上传的图片：</td>
      </tr>
    <tr>
      <td height="30" align="left" valign="middle">
      <input type="file" id="daImageFile" name="daImageFile.file" contentEditable="false" onchange="checkExt(this)" />
      </td>
    </tr>
    <tr>
      <td height="30" align="center" valign="middle">
      	<input value="上传" type="submit" name="btnSubmit" />&nbsp;
      	<input value="取消" type="button" name="btnCancel" onclick="javascript:hideImageUpload()" />
      </td>
      </tr>
  </table>
 </form>
