    ...
    <tr>
	  ...
	  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr style="font-size:18pt">
		     <th colspan="2" height="70" class="head"><br/><br/>煤矿、金属非金属矿山等工况企业安全生产事故隐患排查治理情况月报表<br/><br/></th>
        </tr>
...
function loadOldTable() {
	...
	if (action.indexOf("loadMine") != -1) {
		window.location='printMine.xhtml?mineReport.id=${mineReport.id}'
