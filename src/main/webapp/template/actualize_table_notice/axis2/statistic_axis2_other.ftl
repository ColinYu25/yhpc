...
<table width="30%" border="0" height="30" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td align="center">
		<input name="print" id="sendData" type="button" <#if send?exists><#else><#if userDetail.secondArea!=0>disabled="disabled"</#if></#if> value="<#if send?exists>已经<#else>确定</#if>发送" onclick="sendData();"/>
	</td>
	</#if>
	<td align="center">
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr align="center">
	     <th colspan="2" height="50" style="font-size:20px;line-height:30px;"><input type="text" id="year" onChange="winLocation();" value="${statistic.yearMonth}" onfocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'2010-01',maxDate:'%y-%M-%d %H-%m'})" class="Wdate" size="9" maxlength="8">
...
<table width="100%" cellpadding="0" cellspacing="0" class="table_list">
        ...
        <#assign all_num = (map["s_total"].allCompanyNum)>
		 <#assign num = (map["s_total"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_total"].proviceRcNum + map["s_total"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_18"].companyNum+map["s_13"].companyNum)>
		  ...
		  <td align="center" id="btng"><#if (map["s_18"].bigTroubNum+map["s_13"].bigTroubNum)==0>/<#else>#{((map["s_18"].bigTroubNum+map["s_13"].bigTroubNum-map["s_13"].bigTroubCleanNum-map["s_18"].bigTroubCleanNum)/(map["s_18"].bigTroubNum+map["s_13"].bigTroubNum)*100);M1}</#if></td>
		  ...
		  <td align="center" id="pgp">${map["s_18"].proviceRcNum + map["s_18"].cityRcNum+map["s_13"].proviceRcNum + map["s_13"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_19"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_19"].proviceRcNum + map["s_19"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_20"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_20"].proviceRcNum + map["s_20"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_21"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_21"].proviceRcNum + map["s_21"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_22"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_22"].proviceRcNum + map["s_22"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_23"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_23"].proviceRcNum + map["s_23"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_30"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_30"].proviceRcNum + map["s_30"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_28"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_28"].proviceRcNum + map["s_28"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_29"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_29"].proviceRcNum + map["s_29"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_26"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_26"].proviceRcNum + map["s_26"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_32"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_32"].proviceRcNum + map["s_32"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_25"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_25"].proviceRcNum + map["s_25"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_24"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_24"].proviceRcNum + map["s_24"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_31"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_31"].proviceRcNum + map["s_31"].cityRcNum }</td>
		 ...
		 <#assign num = (map["s_15"].companyNum)>
		  ...
		  <td align="center" id="pgp">${map["s_15"].proviceRcNum + map["s_15"].cityRcNum }</td>
...
<script language="javascript">
	...
	function checkOldData(){
		window.location="loadStatisticForAxis2OtherByParam2.xhtml?statistic.yearMonth="+get("year").value;
		progressText("正在加载统计数据，请稍等...");
	}
	
	function sendData(){
		if(confirm('将发送数据到浙江省隐患排查系统，确定要发送数据吗?')){
			document.getElementById("sendData").disabled=true; 
			window.location="sendDataOfOtherByOMElement.xhtml?statistic.yearMonth="+get("year").value;
			progressText("正在发送数据到浙江省隐患排查系统，请稍等...");
		}
	}
