...
<#if daActualTableNotice?exists>
  		<#assign url='updateTableDownload.xhtml?sysComit=true'>
<#else>
  		<#assign url='createTableDownload.xhtml?sysComit=true'>
</#if>
...
<table border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	<th><#if sysComit><#if daActualTableNotice?exists>修改<#else>添加</#if></#if>表格下载</th>
  </tr>
</table>
<div class="menu">
