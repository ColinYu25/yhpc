...
<#if daActualTableNotice?exists>
  		<#assign url='updateNotice.xhtml?sysComit=true'>
<#else>
  		<#assign url='createNotice.xhtml?sysComit=true'>
</#if>
...
<table border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	<th><#if sysComit><#if daActualTableNotice?exists>修改<#else>添加</#if></#if>通知通告</th>
  </tr>
</table>
<div class="menu">
