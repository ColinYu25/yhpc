...
<div class="main">
	<div class="box">
			<div class="box-con">   
			    <form  style="margin-bottom:0px;margin-top:0px;" action="loadStatisticTableDownload.xhtml?sysComit=${sysComit?string}" method="post" name="tradeTypeForm" id="tradeTypeForm">
