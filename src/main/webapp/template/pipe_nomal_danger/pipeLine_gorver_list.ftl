...
<div class="menu">
  	<ul>
	<li id="img_xcjcjl"><a class="b_xcjcjl" href="javaScript:loadNote('loadNomalDangersGorver.xhtml?entity.id')"><b>隐患列表</b></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <#if result?exists>
	  ...
	  <tr>
	    ...
	    <td title="查看管道信息" style="text-align:center"><a href="../pipeline/yq_pipeline_update.xhtml?entity.id=${item.id}">${item.name}</a>&nbsp;</td>
	    <td title="查看管道隐患信息" onClick="checkDangerByPipeId(${item.id});" style="cursor:pointer;" onMouseOver="this.style.backgroundColor=trMoveColor;" onMouseOut="this.style.backgroundColor='';">${item.repairCount}&nbsp;</td>
	    <td>
...
<script>
	...
	function checkDangerByPipeId(id){
		if(id && id!="")
			window.location = "loadNomalDangersGorver.xhtml?entity.id=" + id;
	}
</script>