...
<div class="menu">
  	<ul>
	<li id="img_save"><a href="createNomalDangerInit.xhtml?entity.id=${entity.id}" class="b_save"><b>添加</b></a></li>
	<li id="img_amend"><a class="b_amend" href="javaScript:loadNoteMore(get('pipeNomalDangerForm'), 'editNomalDangerInit.xhtml')"><b>修改</b></a></li>
