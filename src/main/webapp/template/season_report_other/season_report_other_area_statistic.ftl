...
<table width="98%" cellspacing="1" cellpadding="0" border="0" style="font-family: '宋体'; font-size: 12px; color: #4F6B72;; background-color:#C1DAD7">
          <tr><th height="25" bgcolor="#D6EEF0" align="center" colspan="17"><span class="head">${typeName}</span></th></tr>
        <tr height="20" bgcolor="#dcfafa" align="center">
          <td width="5%" rowspan="5" align="center" widtd="72">区域</td>
          <td width="5%" rowspan="5" align="center" widtd="72">行业和领域</td>
		...
		<#list statistics as sta>
		<#list sta as s>
       <tr height="25" bgcolor="#D6EEF0" align="center">
           <td height="20">${s.areaName}</td>
