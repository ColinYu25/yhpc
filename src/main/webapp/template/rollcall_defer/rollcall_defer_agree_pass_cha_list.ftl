...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap><a href="loadRollcallDeferAgreeForPassCha.xhtml?rollcallDefer.id=${r.id}"><div align="left">在${r.createTime?string('yyyy年MM月dd日')}提交验收申请。</div></a></td>
    ...
    <td><div align="left"><#if r.done?exists&&r.done><#if r.isAgree?exists&&r.isAgree!=2><#if r.isAgree?exists&&r.isAgree==1>同意隐患治理验收申请。
