...
<form action="loadCompanyLogouts.xhtml?type=${type}" method="post" name="companyForm" id="companyForm">
	<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_input">
	  ...
	  <tr>
	    ...
	    <td colspan="2"><div align="left"><input type="submit" id="sub" value="查  询" onClick="get('companyForm').submit();" class="confirm_but" style="height:25px; width:80px" /></div></td>
	  </tr>
	</table>
</form>
<div class="menu">
  	<ul>
	<li id="img_amend">		<a href="#" class="b2" onClick="del(get('companyLogoutForm'));"><b>取消</b></a></li>
	<li id="img_refurbish">	<a href="#" class="b4" onClick="window.location.reload();"><b>刷新</b></a></li>
	<li id="img_return">	<a href="javascript:history.go(-1);" class="b6"><b>返回</b></a></li>
	</ul>
</div>
<form action="deleteCompanyLogout.xhtml?type=${type}" method="post" name="companyLogoutForm" id="companyLogoutForm">
