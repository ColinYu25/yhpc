...
<div class="menu">
  	<ul>
  	<li id="img_xcjcjl"><a class="b_xcjcjl" href="javaScript:loadNote('createDangerInit.xhtml?entity.id')"><b>添加隐患</b></a></li>
	<li id="img_xcjcjl"><a class="b_xcjcjl" href="javaScript:loadNote('loadDangers.xhtml?entity.id')"><b>隐患列表</b></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <#if result?exists>
	  ...
	  <tr>
	    ...
	    <td>
	    ${item.buildEndDate?string('yyyy-MM-dd')}<#if !item.buildEndDate?exists>&nbsp;</#if>
	    </td>	    	    	    
	  </tr>
	 </#list>
  </#if>
...
<script>
	...
	function checkDangerByPipeId(id){
		if(id && id!="")
			window.location = "loadDangers.xhtml?entity.id=" + id;
	}
</script>