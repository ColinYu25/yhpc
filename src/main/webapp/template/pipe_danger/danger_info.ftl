...
<table width="98%" cellpadding="0" cellspacing="0" class="table_input">
  ...
  <tr>
    ...
    <#if industryParameters?exists>
  	<#list industryParameters?if_exists as i>
  		...
  		<input type="checkbox" ${checked} name="danger.industryParameters" value="${i.id}" />&nbsp;${i.name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	</#list>
  	</#if>
 ...
 <tr>
  ...
  <tr>
    ...
    <td><input name="danger.governMoney" type="text" size="6" id="governMoney" value="${danger.governMoney.toString()}" maxlength="15"> 万元<span class="red_point">*</span><ui:v for="governMoney" rule="double" empty="&nbsp;" pass="&nbsp;" warn="&nbsp;" warn="&nbsp;"/></td>
  </tr>
  <tr>
...
<input type="hidden" name="danger.pipeLine.id" value="${danger.pipeLine.id}" id="pipeLineId"/>
</form>
