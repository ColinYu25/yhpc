...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap id="roleName" name="roleName"><div align="left"><a href="../company/loadCompany.xhtml?company.id=${r.daDanger.daCompanyPass.id}">${r.daDanger.daCompanyPass.daCompany.companyName}</a>&nbsp;</div></td>
