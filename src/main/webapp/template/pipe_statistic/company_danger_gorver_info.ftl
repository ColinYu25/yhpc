		...
		<div class="box">
				<div class="box-top">
					<div class="box-nav" style="text-align:center;">
							<span style="font-size:27px;font-weight:bold;color:#394C86">管道重大事故隐患治理情况表</span>
					</div>
				</div>
				<div class="box-con">  
					<table width="986" border="0" cellspacing="0" cellpadding="0" class="table01" style="margin-top:0px;">
						<tr class="tbbg"style="font-size:11px;font-weight:bold;">
				         ...
				         <tr class="table03">
						    <td colspan="2" height="25" align="right"><strong>管道名称：</strong></td>
						    <td colSpan="2" style="text-align:left">&nbsp;${danger.pipeLine.name}</td>
						  ...
						  <tr bgcolor="#ffffff" class="table03">
						    ...
						    <td colSpan="2" style="text-align:left">&nbsp;${danger.pipeLine.daPipelineCompanyinfo.company.companyName}</td>
						    <td align="right"><strong>单位地址：</strong></td>
						    <td colspan="2" style="text-align:left">&nbsp;${danger.pipeLine.daPipelineCompanyinfo.company.regAddress}</td>
						  </tr>
						  <tr class="table03">
						  ...
						  <tr bgcolor="#ffffff" class="table03">
						    <td height="25" width="23%" colspan="2" rowspan="2" align="right" nowrap> <p><strong>隐患整治情况：</strong><BR>
						      （简述）</p></td>
						  ...
						  <tr class="table03">
						  	<td height="25" width="20%" align="center" nowrap><strong>治理验收评估情况</strong></td>
