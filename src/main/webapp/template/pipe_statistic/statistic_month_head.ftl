		...
		<div class="box-top">
			<div class="box-nav">
				<ul class="<#if statistic?? && statistic.areaType?? && statistic.areaType=='third_area'>fnlist_3<#else>fnlist3</#if>">
					<#if statistic?? && statistic.areaType?? && statistic.areaType=='third_area'><li><a href="loadMonth.xhtml?statistic.areaCode=330200000000&statistic.remark=${statistic.remark}&statistic.year=${statistic.year}&statistic.quarter=${statistic.quarter}&statistic.month=${statistic.month}">返回市级统计</a></li></#if>
					<li><a <#if !(statistic.remark?? && statistic.remark != '')>class="hover"</#if> href="loadMonth.xhtml?statistic.areaCode=${statistic.areaCode}&statistic.remark=&statistic.year=${statistic.year}&statistic.quarter=${statistic.quarter}&statistic.month=${statistic.month}">各地管道月报情况</a></li>
					<li><a <#if statistic.remark?? && statistic.remark != ''>class="hover"</#if> href="loadMonth.xhtml?statistic.areaCode=${statistic.areaCode}&statistic.remark=anjian&statistic.year=${statistic.year}&statistic.quarter=${statistic.quarter}&statistic.month=${statistic.month}">各部门管道月报情况</a></li>
				</ul>
			</div>
		</div>
		<#assign menuName = "季度"/>
