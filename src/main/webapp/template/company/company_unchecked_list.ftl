...
<form action="loadUnCheckedCompanies.xhtml" method="post" name="companyForm" id="companyForm">
...
<div class="menu">
  	<ul>
  	<li id="img_amend">		<a href="#" class="b2" onClick="addComapnyPass()"><b>确认</b></a></li>
	<li id="img_xcjcjl">		<a href="#" class="b_xcjcjl" onClick="addComapnyLogout1()"><b>企业注销</b></a></li>
	<!--
	<li id="img_xcjcjl">		<a href="#" class="b_xcjcjl" onClick="addComapnyLogout2()"><b>无经营场所</b></a></li>
...
<form action="../companyLogout/createCompanyLogout.xhtml" method="post" name="companyLogoutForm" id="companyLogoutForm">
	<input type="hidden" name="companiesIds" id="daCompanyLogoutId" value=""/>
	<input type="hidden" name="tp" id="type" value=""/>
</form>
...
<script type="text/javascript">
	...
	function addComapnyLogout1(){
		...
		get("daCompanyLogoutId").value=companyIds.substring(0,companyIds.length-1);
		get("type").value=1;
		get("companyLogoutForm").submit();
	}
	function addComapnyLogout2(){
		var checkboxs = document.getElementsByName("ids");
		var checkSize = 0;
		var companyIds="";
		var num=0;
