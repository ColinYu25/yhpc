...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	...
	<form action="loadCompaniesForClassify1.xhtml" method="post" name="companyForm" id="companyForm">
	  <tr>
	    <th>单位名称</th>
...
<div class="menu">
  	...
  	<li id="img_zgtzs"><a href="#" class="b_zgtzs" onClick="loadNote('loadCompanyForClassify1.xhtml?company.id')"><b>企业分类</b></a></li>
