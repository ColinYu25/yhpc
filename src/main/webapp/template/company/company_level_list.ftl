...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	...
	<form action="loadCompaniesForLevel.xhtml" method="post" name="companyForm" id="companyForm">
	  <tr>
	    <th>单位名称</th>
	  ...
	  <tr>
	    <th>行业部门</th>
	    <td nowrap><select name="company.tradeTypes" id="tradeTypes1" onchange="changeTrade(this.value,1);"><option value="">--请选择--</option><#list tradeTypes?if_exists as t><#if t.type==1><option value="${t.id}" <#if userDetail.userIndustry!='anwei'>selected</#if>>${t.name}</option></#if></#list></select>
...
<div class="menu">
  	...
  	<li id="img_zgtzs"><a href="#" class="b_zgtzs" onClick="loadNote('loadCompanyForLevel.xhtml?company.id')"><b>企业分级分类</b></a></li>
