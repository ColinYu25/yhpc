...
<table border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	<th><#if file?exists>修改<#else>添加</#if><#if type>督办方案、治理方案<#else>会议记录、纪要</#if></th>
  </tr>
</table>
<div class="menu">
...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_input">
      ...
      <tr>
      <th colspan="2">附件</th>
        <td><input name="file.file" type="file" class="input" id="filePath" value="${file.file}" contentEditable="false" style="width:200px">&nbsp;<span style=color:red>*<a href="${contextPath}${file.fileRealPath}">${file.fileFileName}</a></span></td>
      </tr>
      </table></tr>
