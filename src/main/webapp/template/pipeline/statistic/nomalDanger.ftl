				...
				<table cellspacing="1" cellpadding="0" border="0" align="center"  width="99%" class="table_list2">
				 	<tr align="center">
					 	...
					 	<#if areas?exists>
		  		 		...
		  		 		<td width="${90/(areas?size + 1)}%"><strong>合1计</strong></td>
				  	</tr>
				  	<tr align="center">
				  		<td height="22" rowspan="3" nowrap><strong>合2计&nbsp;</strong></td>
...
<script>
	...
	function changeYearUrl(year) {
		window.location = "loadNomalDanger.xhtml?statistic.type=${statistic.type}&statistic.year="+year+"&statistic.areaCode=${statistic.areaCode}";
	}
	
	function changeTypeUrl(type) {
		window.location = "loadNomalDanger.xhtml?statistic.type="+type+"&statistic.year=${statistic.year}&statistic.areaCode=${statistic.areaCode}";
	}
	
	function changeAreaUrl(areaCode) {
		window.location = "loadNomalDanger.xhtml?statistic.type=${statistic.type}&statistic.year=${statistic.year}&statistic.areaCode=" + areaCode;
	}
	
	function showAreaDetail(dType, areaCode, repaired) {
		window.location = "loadNomalDangerDetail.xhtml?statistic.dType="+dType+"&statistic.repaired="+repaired+"&statistic.type=${statistic.type}&statistic.secondArea=${statistic.areaCode}&statistic.areaType=${statistic.areaType}&statistic.year=${statistic.year}&statistic.areaCode=" + areaCode;
	}
</script>
<@fkMacros.pageFooter />