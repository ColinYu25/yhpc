...
<div id="main">
	<div id="contents">
		...
		<form id="companyForm" name="companyForm" method="post" action="rq_pipeline_save.xhtml">
			...
			<input type="hidden" name="entity.ghxklx" value="${entity.ghxklx}" id="ghxklx"/>
			<input type="hidden" name="entity.jgys" value="${entity.jgys}" id="jgys"/>
			<input type="hidden" name="entity.ylgdsydj" value="${entity.ylgdsydj}" id="ylgdsydj"/>
			<input type="hidden" name="entity.hasJyxkq" value="${entity.hasJyxkq?string('true','false')}" id="hasJyxkq"/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      ...
		      <tr>
		        <th style="width:15%">输送介质</th>
		        <td style="width:22%">
		        	 <label><input type="checkbox" name="entity.medium" value="液化气" <#if entity.medium?exists && entity.medium?contains('液化气')>checked</#if> /> 液化气 </label>
			        <label><input type="checkbox" name="entity.medium" value="天然气" <#if entity.medium?exists && entity.medium?contains('天然气')>checked</#if> /> 天然气</label>
			        <label><input type="checkbox" name="entity.medium" value="空混气" <#if entity.medium?exists && entity.medium?contains('空混气')>checked</#if> /> 空混气</label>
		        </td>
	    	...
	    	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      <tr>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openAttech(7,'★与市政公用等其他管线交叉',200);">处
		        </td>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openAttech(8,'★油气管道穿越其他管线封闭空间',200);">处
		      </tr>
		      <tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      <tr>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openAttech(9,'★地面管线存在腐蚀、破损、开裂、变形、老化和跑、冒、滴、漏',450);">处
		        </td>
		      ...
		      <tr>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openAttech(4,'★管道被违法占压情况',500);">处
		        </td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      ...
		      <tr>
		        <th colspan="3" style="width:40%">机组等设备、设施是否设置自动保护装置</th>
		        <td style="width:20%">
		        	 <#assign isTrue=""/>
			    	<#assign isFalse="checked"/>
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      ...
		      <tr>
		        ...
		        <th style="width:10%" colspan="3">是否配备相关抢险设备、器材和设施</th>
		        <td style="width:20%">
					 <#assign isTrue=""/>
			    	<#assign isFalse="checked"/>
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      ...
		      <tr>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openAttech(2,'★管道安全防护区内建设施工情况',1050);">处
		        </td>
		        ...
		        <td style="width:20%">
		        	...
		        	onclick="openTrouble('★其它存在的隐患',1050);">处
		        </td>
		      </tr>
		    </table>
		    <br/>
