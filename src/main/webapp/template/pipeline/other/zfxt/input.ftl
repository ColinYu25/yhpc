...
<div id="main">
	<div id="contents">
		...
		<form id="companyForm" name="companyForm" method="post" action="zfxt_save.xhtml" enctype="multipart/form-data">
		<input type="hidden" name="entity.id" value="${entity.id}"/>
		<input type="hidden" name="entity.daPipelineInfo.id" value="${entity.daPipelineInfo.id}" id="pipeLineId"" />
		<input type="hidden" name="entity.type" value="5" />
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_input">
		      <tr>
		        ...
		        <ui:v for="title"  rule="require" empty="标题不允许为空" pass="&nbsp;" warn="&nbsp;"/></td>
		      </tr>
		      <tr>
		        <th>区域</th>
		        <td>
