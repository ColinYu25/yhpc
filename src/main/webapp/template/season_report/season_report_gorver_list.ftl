...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_input">
  <tr>
    <th>单位名称</th>
    <td width="33%"><input type="text" name="company.companyName" id="companyName" value="${company.companyName}" size="37"></td>
	<th>单位区域</th>
...
<div class="menu">
	<div style="float:left;">
  	<ul>
	<li id="img_left"></li>
	<li id="img_amend"><a href="javascript:loadNote('loadNomalDangersGorver.xhtml?daNomalDanger.nowYear=${daNomalDanger.nowYear}&company.id');" class="b2"><b>修改</b></a></li>
