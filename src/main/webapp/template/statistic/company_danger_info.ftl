		...
		<div class="box">
				<div class="box-top">
					<div class="box-nav" style="text-align:center;">
							<span style="font-size:23px;font-weight:bold;color:#394C86">重大事故隐患情况表</span>
					</div>
				</div>
				<div class="box-con">  
					<table width="986" border="0" cellspacing="0" cellpadding="0" class="table01" style="margin-top:0px;">
						<tr class="tbbg"style="font-size:11px;font-weight:bold;">
				         ...
				         <tr bgcolor="#ffffff" class="table03">
							<td style="width:14%;" height="25" align="right" nowrap><strong>单位名称：</strong></td>
						  ...
						  <tr  class="table03">
						    <td style="width:12%;" height="25" align="right" nowrap ><strong>单位地址：</strong></td>
						    <td colspan="2" style="text-align:left">&nbsp;<#if company.regAddress?exists>${company.regAddress}</#if></td>
						    <td width="11%" align="right" nowrap><strong>市级以上重点工程：</strong></td>
							<td colspan="2" style="text-align:left"> <input type="radio" name="danger.emphasisProject" disabled value="true" <#if danger?if_exists.emphasisProject?exists&&danger.emphasisProject>checked</#if>>
						      是    
						      <input type="radio" name="danger.emphasisProject" disabled value="false" <#if !danger?if_exists.emphasisProject?exists||!danger.emphasisProject>checked</#if>>
						    否</td>
						  </tr>
						  <tr bgcolor="#ffffff" class="table03">
			...
			<script language="javascript">
			  ...
			  <#if danger?exists>
				...
				<#if danger.thirdArea?? &&  danger.thirdArea != 0>
