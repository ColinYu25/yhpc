...
<div class="list_title_blue" >		${area.areaName}企业一般事故隐患情况列表
</div>
	...
	<div id="main_content">
				...
				<!--	<form  style="margin-bottom:0px;margin-top:0px;" action="loadNomalTroubleForColligation.xhtml?<#if statistic.remark?exists && statistic.remark!=''>&statistic.remark=${statistic.remark}&</#if>statistic.isSonType=${statistic.isSonType}&statistic.year=${statistic.year}&statistic.quarter=${statistic.quarter}&area.areaCode=${area.areaCode}&statistic.isGorver=${statistic.isGorver}" method="post" name="companyForm" id="companyForm">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_tab">
				      <tr class="tbbg" style="font-size:16px;font-weight:bold;">
			       		...
			       		<a style="margin-left:10px;margin-right:10px;float:right;" class="b6" href="loadDangerTroubleForColligation.xhtml?area.areaCode=${area.areaCode}&statistic.isSonType=${statistic.isSonType}&statistic.year=${statistic.year}&statistic.quarter=${statistic.quarter}&statistic.isRollcall=${statistic.isRollcall}&statistic.isGorver=${statistic.isGorver}">
		       		<!--	<b><img style="border:0px" src="${resourcePath}/images/022.gif" /></b></a>-->
			       	</td>
					  </tr>
					  <tr>
						<td colspan="4">
					   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  	<tr class="table02">
									<td width="3%" rowspan="2" nowrap>序号</td>
									<td width="25%" rowspan="2">企业名称</td>
									<td width="30%" rowspan="2">隐患描述</td>
									<td width="10%" colspan="3">隐患类别</td>
									<td width="8%" rowspan="2">录入时间</td>
									<td width="10%" colspan="2">录入方式</td>
									<td width="10%" colspan="2">治理状态</td>
								</tr>
								<tr class="table02">
									<td width="4%">人</td>
									<td width="4%">物</td>
