...
<div class="list_title_blue" >	企业重大事故隐患情况列表
</div>
	...
	<div id="main_content">			
				    ...
				    <table class="table02" style="background:#F5F5F5;">
					    <tr>
					    	<td nowrap width="20%" style="font-size:16px;border-right:0px solid #AED4F3;font-weight:bold;border-bottom:0px solid #AED4F3;"><div style="text-align:center">${area.areaName}&nbsp;</div></td> 
					      	...
					      	<td nowrap width="20%" style="font-size:16px;border-right:0px solid #AED4F3;font-weight:bold;border-bottom:0px solid #AED4F3;"><div style="text-align:center">${statistic.year}年<#if statistic.beg_month!=0>${statistic.beg_month}月</#if>到${statistic.year+1}年<#if statistic.end_month!=0>${statistic.end_month}月</#if></div></td> 
					     </tr>
				    </table>  
				    </form>		    
					...
					<div style="margin-left:-5px;text-align:left">
						<table  width="100%"  cellpadding="0" cellspacing="5">
							<tr>
							<td >
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border: #CCCCCC solid 1px; border-collapse: collapse; background: #f6f6f6; font-size: 12px;line-height:200%;">
									<tr>
