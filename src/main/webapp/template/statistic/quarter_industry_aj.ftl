			...
			<div class="fn2">
					...
					<div class="left">
						...
						<b> <#assign title=""/>
				           ...
				           ${title}<#if statistic.remark=='anjian_other'>其他行业<#else>${s.enumName}季报进度</#if></b>
					</div>
					<div class="right">
						<ul class="fnlist">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				   ...
				   <#list statistics?if_exists as hy>
					  ...
					  <tr class="table03" <#if hy_index%2==0>bgcolor="#ffffff"<#else>bgcolor="#F5F5F5"</#if> align="center">
					  	...
					  	<#elseif i_index==1>
					  		<td nowrap="true" width="6%"><strong>未季报数</strong></td><#assign ptype='q'>
					  	<#elseif i_index==2>
					  		<td nowrap="true" width="6%"><strong>季 报 率</strong></td>
					  	</#if>
					  	<#assign rowTotal=0>
					  	<#list areas?if_exists as a>
       ...
       if(year==changeYear1){
		...
		function showArea(areaCode) {
			...
			<#if statistic.remark=='anjian_other'>
				window.location = "loadQuarterByIndustryOfAjOther.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode="+areaCode+"&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter=${statistic.quarter}";
			<#else>
				window.location = "loadQuarterByIndustryOfAj.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode="+areaCode+"&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter=${statistic.quarter}";
			</#if>
			}
		}
		function loactionUrl(remark) {
			if (remark !=null && remark == 'anjian_other'){
				window.location = "loadQuarterByIndustryOfAjOther.xhtml?statistic.remark="+remark;
			}else{
				window.location = "loadQuarterByIndustryOfAj.xhtml?statistic.isSonType=1&statistic.remark="+remark;
			}
		}
		...
		function changeQUrl() {
			<#if statistic.remark=='anjian_other'>
				window.location = "loadQuarterByIndustryOfAjOther.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode=${area.areaCode}&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter="+arguments[0];
			<#else>
				window.location = "loadQuarterByIndustryOfAj.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode=${area.areaCode}&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter="+arguments[0];
			</#if>
		}
		
		function showMonthData(month) {
			<#if statistic.remark=='anjian_other'>
				window.location = "loadQuarterByIndustryOfAjOther.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode=${area.areaCode}&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter=${statistic.quarter}&statistic.month=" + month;
			<#else>
				window.location = "loadQuarterByIndustryOfAj.xhtml?statistic.isSonType=1&statistic.remark=${statistic.remark}&area.areaCode=${area.areaCode}&statistic.year="+get("year").value.substring(0,4)+"&statistic.quarter=${statistic.quarter}&statistic.month=" + month;
			</#if>
		}
	</script>
