	...
	<div class="box">
			<div class="box-top">
				<div class="box-nav" style="text-align:center;">
						<span style="font-size:23px;font-weight:bold;color:#394C86">项目列表</span>
				</div>
			</div>
			<div class="box-con"> 
				   	  ...
				   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <#if items?exists && items?size gt 0>
							  ...
							  <tr class="table03" <#if c_index%2==0>bgcolor="#ffffff"<#else>bgcolor="#F5F5F5"</#if>>
							    ...
							    <td><div align="left"><#if c.itemname?exists>${c.itemname}<#else>&nbsp;</#if></div></td>
							    <td><div align="left"><#if c.itemaddress?exists>${c.itemaddress}<#else>&nbsp;</#if></div></td>
