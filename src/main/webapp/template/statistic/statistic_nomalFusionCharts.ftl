...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table height="31"  cellpadding="0" cellspacing="0" width="601" class="zxgg"  background="${resourcePath}/img/right_14.gif" style="border:#519ccc solid 1px; border-bottom:none" >
      <tr >
        <td width="300" id='aTabTitle' name='aTabTitle' onClick="ShowTabss('aTabTitle','aTabs',0);" align="center" class="selectli1"><a href="#" class="a_blue_12b">${statistic.year}年${chart.num1}安全生产隐患排查一般隐患统计图</a></td>
        <td width="1" bgcolor="#519ccc"></td>
        <td width="300" id='aTabTitle' name='aTabTitle' onClick="ShowTabss('aTabTitle','aTabs',1);" align="center" ><a href="#" class="a_blue_12">${statistic.year}年各${chart.num1}安全生产隐患排查一般隐患统计图</a></td>
      </tr>
    </table></td>
  </tr>
  <tbody id='aTabs' name='aTabs'>
    <!--<tr> 
	   <td  align="center"  >
	   	    <input type="text" id="year" onChange="winLocation();" value="2014-09" onfocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'2010-01',maxDate:'%y-%M-%d %H-%m'})" class="Wdate" size="9" maxlength="8">
	   </td>
	</tr>  -->
    <tr>
