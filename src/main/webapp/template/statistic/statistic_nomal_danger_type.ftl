	...
	<script type="text/javascript">
		...
		function showArea(areaCode) {
			if("${area.gradePath}".split("/").length-1 == 4) {
				...
				window.location = "loadNomalDangerTypeByIndustry.xhtml?remark=${remark}&area.areaCode="+areaCode;
			}
		}
		function showDetail(areaCode,industryId,isGorver) {
			window.location = "loadNomalDangerTypeByIndustryList.xhtml?area.areaCode="+areaCode+"&statistic.industryId="+industryId+"&statistic.isGorver="+isGorver;
		}
	</script>
