...
<div class="main">
	<div class="box">
			<div class="box-top">
				<div class="box-nav">
					<ul class="fnlist3">
						<li><a <#if !statistic.remark?exists || statistic.remark==''>class="hover"</#if> href="loadMassAll.xhtml">各地排查质量</a></li>
						<li><a <#if statistic.remark?exists && statistic.remark!=''>class="hover"</#if> href="loadMassByIndustry.xhtml?statistic.remark=anjian">各部门排查质量</a></li>
					</ul>
				</div>
			</div>