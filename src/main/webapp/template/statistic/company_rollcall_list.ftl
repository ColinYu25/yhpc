		...
		<div class="box">
				<div class="box-top">
					<div class="box-nav" style="text-align:center;">
							<span style="font-size:27px;font-weight:bold;color:#394C86">重大事故隐患挂牌督办情况列表</span>
					</div>
				</div>
				<div class="box-con">  
						...
						<td colspan="4">
					   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  	<tr class="table02">
								    ...
								    <td width="9%" nowrap>隐患编号</td>
								    <td width="18%" nowrap>隐患地址</td>
								    <td width="6%" nowrap>是否整改</td>
								    <td width="7%" nowrap>挂牌级别</td>
							  ...
							  <#if rollcallCompanies?exists>
								  <#list rollcallCompanies?if_exists as r>
								    ...
								    <td id="roleName" name="roleName"><div align="left">${r.daDanger.daCompanyPass.daCompany.companyName}&nbsp;</div></td>
								    <td nowrap><#if r.daDanger.dangerNo?exists>${r.daDanger.dangerNo}</#if>&nbsp;</td>
								    <td><div align="left"><#if r.daDanger.dangerAdd?exists>${r.daDanger.dangerAdd}</#if>&nbsp;</div></td>
