      ...
      <td height="100%"><table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0" class="table_4_blue11" style="border-top:none">
        <tr>
         ...
         <table width="90%" border="0" height="20" cellspacing="0" align="center" cellpadding="0">
		  <tr>
		   <tr><td align="center" colspan="${areasByGroupNum?size+3}"><br><strong style="font-size:23px;line-height:30px;">房屋建设工程安全生产隐患排查治理情况统计年报表</strong></td></tr>
		  </tr>
...
<script type="text/javascript">
	...
	function winLink() {
			window.location = "loadReportByItem.xhtml";
		}
	<#if area.areaCode==330200000000>roleName();</#if>
		function showArea(areaCode) {
			if("${area.gradePath}".split("/").length-1 == 4) {
				...
				window.location = "loadReportByItemAll.xhtml?statistic.remark=${statistic.remark}&area.areaCode="+areaCode+"&statistic.year="+get("year").value.substring(0,4);
			}
		}
