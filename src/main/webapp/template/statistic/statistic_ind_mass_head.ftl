              ...
              <ul>
				<li class="ssfd1"><a <#if statistic.remark == 'anjian'>class="hover"</#if> href="#" onclick="changeUrl('anjian')">安监</a></li>
				...
				<li class="ssfd1"><a <#if statistic.remark == 'chengguan'>class="hover"</#if> href="#" onclick="changeUrl('chengguan')">城管</a></li>
				<li class="ssfd1"><a <#if statistic.remark == 'jiaotong'>class="hover"</#if> href="#" onclick="changeUrl('jiaotong')">交通</a></li>
				<li class="ssfd1"><a <#if statistic.remark == 'shuili'>class="hover"</#if> href="#" onclick="changeUrl('shuili')">水利</a></li>
              ...
              function changeUrl(remark) {
				if(remark==null || remark=='') {
					...
					window.location = "loadMassByIndustry.xhtml?statistic.isSonType=1&statistic.remark="+remark;
				}
			}
			...
			function changeUrlItem(remark) {
				if(remark==null || remark=='') {
					...
					window.location = "loadItemByIndustry.xhtml?statistic.isStType=2&statistic.remark="+remark;
				}
			}
			...
			function changeUrlReportOther(remark) {
				if(remark==null || remark=='') {
					...
					window.location = "loadStatisticsOfSeasonReportOther.xhtml?statistic.isStType=2&statistic.remark="+remark;
				}
			}
			</script>