...
<div class="menu">
	...
	<#if userDetail.userIndustry=='qiye'>
		<li id="img_xcjcjl"><a href="javascript:loadNote('../pipeRollcallDefer/loadRollcallDefers.xhtml?rollcallCompany.id');" class="b_xcjcjl"><b>企业延期申请</b></a></li>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap>${r.daPipeDanger.dangerNo}&nbsp;</td>
    <td nowrap><div align="center"><a href="../danger/loadDanger.xhtml?danger.id=${r.daPipeDanger.id}">${r.daPipeDanger.dangerAdd}</a>&nbsp;</div></td>
