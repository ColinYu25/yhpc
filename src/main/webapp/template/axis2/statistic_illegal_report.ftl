...
<center>
<table width="45%" border="0" height="30" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td align="center">　　　　　　　　　　　　
	<input name="print" type="button"  value="发送数据"  onclick="javascript:window.location='loadStatisticForAxis2ThreeIllegal.xhtml'"/>
	</td>
  </tr>
</table>
</center>
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <input type="text" id="year" value="${statistic.year}年" onfocus="WdatePicker({dateFmt:'yyyy年',minDate:'2009',maxDate:'%y-%M-%d %H-%m'})" onChange="changeQUrl();" class="Wdate" size="8" maxlength="6">
	...
	<#if statistics?exists>
       <#list statistics?if_exists as s>
        <tr height="25" align="center">
          ...
          <td id="td_bcd" name="td_bcd">${s.cnum}</td>
		  <td id="td_bcg" name="td_bcg">${s.bnum}</td>			  
          <td id="td_pg" name="td_pg">${s.aanum}</td>
          <td id="td_pcg" name="td_pcg">${s.ccnum}</td>
          <td id="td_pcd" name="td_pcd">${s.bbnum}</td>			  
          <td id="td_tg" name="td_tg">${s.aaanum}</td>
          <td id="td_tcg" name="td_tcg">${s.cccnum}</td>
          <td id="td_tcd" name="td_tcd">${s.bbbnum}</td>
        </tr>
		</#list>
	</#if>
	<tr height="25" align="center">
