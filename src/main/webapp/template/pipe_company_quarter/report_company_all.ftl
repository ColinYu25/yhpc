    ...
    <tr>
      <td height="100%"><table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0" class="table_4_blue11" style="border-top:none">
        <tr>
		  ...
		  <tr>
		   <tr><td align="center" colspan="${areas?size+3}"><br><strong style="font-size:16px;line-height:40px;">生产经营单位（组织）油气管道安全生产隐患排查治理情况统计年报表</strong></td></tr>
		  </tr>
...
<table cellspacing="0" align="center" cellpadding="0" class="table_input2" width="650">
  <TR>
	<td width="10%" rowSpan="1" colSpan="2" align="center"><strong>管道名称</strong></td>
  ...
  <TR>
    ...
    <TD colSpan="3">${statisticForCompany.address}&nbsp;</TD>
  </TR>
  <TR>
    <td align="center"><strong>区　域</strong></td>
    <TD colSpan="3">&nbsp;　　　　　${statisticForCompany.areaName}　　　　　　　　县（市）区　　　　　　　　　　　乡镇（街道）</TD>
  </TR>
  <TR>
...
<script type="text/javascript">
	...
	function ShowTabss(obj,tabs,ID){ 
		...
		function winLink() {
			window.location = "editInit.xhtml";
		}
