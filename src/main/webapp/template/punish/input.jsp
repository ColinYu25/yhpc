        ...
        <tr>
		  ...
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_list">
            ...
            <tr>
              ...
              <td>（人）</td>
              <td>（人）</td>
              <td nowrap><font color=red ><strong>（万元）</strong></font></td>
            </tr><!-- 
            <tr>
              <td width="8%">&nbsp;</td>
              <td width="8%">1</td>
			...
			<c:choose>
	            <c:when test="${status.count==1}">
		            <tr id="row${status.count-1}">
		             ...
		             <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="checkTeam_${status.count-1}" value="${details[status.count-1].checkTeam}" name="details[${status.count-1}].checkTeam"  class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="closed_${status.count-1}" value="${details[status.count-1].checkPerson}" name="details[${status.count-1}].checkPerson" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="companyNum_${status.count-1}" value="${details[status.count-1].companyNum}" name="details[${status.count-1}].companyNum" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
					  <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="warn_${status.count-1}" value="${details[status.count-1].warn}" name="details[${status.count-1}].warn" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="orderRectify_${status.count-1}" value="${details[status.count-1].orderRectify}" name="details[${status.count-1}].orderRectify" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="confiscate_${status.count-1}" value="${details[status.count-1].confiscate}" name="details[${status.count-1}].confiscate" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="stopProduct_${status.count-1}" value="${details[status.count-1].stopProduct}" name="details[${status.count-1}].stopProduct" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="tempDetain_${status.count-1}" value="${details[status.count-1].tempDetain}" name="details[${status.count-1}].tempDetain" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="close_${status.count-1}" value="${details[status.count-1].close}" name="details[${status.count-1}].close" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="administrativeDetain_${status.count-1}" value="${details[status.count-1].administrativeDetain}" name="details[${status.count-1}].administrativeDetain" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="criminalResponsibility_${status.count-1}" value="${details[status.count-1].criminalResponsibility}" name="details[${status.count-1}].criminalResponsibility" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/>-</td>
		              <td align="center" ><input type="hidden" style="IME-MODE:disabled;" id="penalty_${status.count-1}" value="${details[status.count-1].penalty}" name="details[${status.count-1}].penalty" class="input" maxlength="8" size="4" onchange="calculate(this,3)" onKeyDown="checkNumber(this,3)"   onBlur='moneyts();'  />-</td>
		            </tr>
	            </c:when>
	            <c:otherwise>
	            	<tr id="row${status.count-1}">
					  <td style="text-align:left;font-weight:bold;" nowrap="nowrap">${item.value}</td><input type="hidden" name="details[${status.count-1}].type" value="${item.key}"/>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="checkTeam_${status.count-1}" value="${details[status.count-1].checkTeam}" name="details[${status.count-1}].checkTeam"  class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="closed_${status.count-1}" value="${details[status.count-1].checkPerson}" name="details[${status.count-1}].checkPerson" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="companyNum_${status.count-1}" value="${details[status.count-1].companyNum}" name="details[${status.count-1}].companyNum" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
					  <td align="center" ><input type="text" style="IME-MODE:disabled;" id="warn_${status.count-1}" value="${details[status.count-1].warn}" name="details[${status.count-1}].warn" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="orderRectify_${status.count-1}" value="${details[status.count-1].orderRectify}" name="details[${status.count-1}].orderRectify" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="confiscate_${status.count-1}" value="${details[status.count-1].confiscate}" name="details[${status.count-1}].confiscate" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="stopProduct_${status.count-1}" value="${details[status.count-1].stopProduct}" name="details[${status.count-1}].stopProduct" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="tempDetain_${status.count-1}" value="${details[status.count-1].tempDetain}" name="details[${status.count-1}].tempDetain" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="close_${status.count-1}" value="${details[status.count-1].close}" name="details[${status.count-1}].close" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="administrativeDetain_${status.count-1}" value="${details[status.count-1].administrativeDetain}" name="details[${status.count-1}].administrativeDetain" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="criminalResponsibility_${status.count-1}" value="${details[status.count-1].criminalResponsibility}" name="details[${status.count-1}].criminalResponsibility" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"/></td>
		              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="penalty_${status.count-1}" value="${details[status.count-1].penalty}" name="details[${status.count-1}].penalty" class="input" maxlength="8" size="4" onchange="calculate(this,3)" onKeyDown="checkNumber(this,3)"   onBlur='moneyts();'  /></td>
		            </tr>
	            </c:otherwise>
            </c:choose>
   ...
   <tr>
	   ...
	   <tr>
		 ...
		 <c:choose>
		  		...
		  		<c:otherwise>
		  			 有关要求：统计数据为本年1月份以来的累计数据，请于每月3日以网上填报方式报送至市安委会办公室。
		  		</c:otherwise>
		  	</c:choose>
		 </td>
	   </tr>
...
<input type="hidden" id="cityCreate" name="entity.cityCreate" value="${entity.cityCreate}"/>
</form>
<script>
var j = jQuery.noConflict();
for(var i = 1; i < 13; i++){
	...
	if (!isNaN(spanTo)){
		...
		j("#tf tr:last td:eq("+(i)+") input:first-child").val(formatFloat(spanTo,3));
	}
}
