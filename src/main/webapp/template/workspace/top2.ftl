...
<div id="top">
	...
	<table width="100%" height="84" border="0" cellpadding="0" cellspacing="0" style="background:url(${resourcePath}/img/top_bg.jpg) left top repeat-x;">
	  	<tr>
	    	<td height="84" valign="bottom" align="right" style="background:url(${resourcePath}/img/top2.jpg) left top no-repeat;">
	    		<div class="top_right">
		    		...
		    		<a href="javascript:openWebWord();">操作说明</a>
		    	</div>
...
<script type="text/javascript">
	...
	function backToHome(){
		window.parent.rightFrame.location.href="loadRightWorkSpacePipe.xhtml";
	}
	
	function redirect(){
		window.parent.location.href="loadMainWorkSpace1.xhtml";
	}
	...
	function openWebWord(){
		window.open("../resources/default/img/<#if userDetail?? && userDetail.userIndustry?? && userDetail.userIndustry=='qiye'>qy.doc<#else>zf.doc</#if>");
	}
</script>
</html>