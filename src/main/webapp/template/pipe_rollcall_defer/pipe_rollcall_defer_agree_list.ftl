...
<div class="menu">
	<div style="float:left;">
  	<ul>
	<li id="img_left"></li>
	<li id="img_save"><a href="javascript:window.location='createRollcallDeferAgreeInit.xhtml?rollcallCompany.id=${rollcallCompany.id}'" class="b1"><b>添加</b></a></li>
	<li id="img_amend"><a href="javascript:loadNote('loadRollcallDeferAgree.xhtml?rollcallDefer.id');" class="b2"><b>修改</b></a></li>
	<li id="img_del"><a href="javascript:deleteNote(get('rollcallDeferFormForDelete'),'deleteRollcallDeferAgree.xhtml');" class="b3"><b>删除</b></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap><a href="loadRollcallDeferAgree.xhtml?rollcallDefer.id=${r.id}"><div align="center">在${r.createTime?string('yyyy年MM月dd日')}提交验收申请。</div></a></td>
