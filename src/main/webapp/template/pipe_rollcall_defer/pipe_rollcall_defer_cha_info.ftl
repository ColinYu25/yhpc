...
<#if danger.secondArea?exists><#if danger.secondArea!=0>get("area_value").innerHTML="&nbsp;"+areaObj.getArea("${danger.secondArea}")[0];</#if></#if>
<#if danger.thirdArea?exists><#if danger.thirdArea!=0>get("area_value").innerHTML+=areaObj.getArea("${danger.thirdArea}")[0];</#if></#if>
