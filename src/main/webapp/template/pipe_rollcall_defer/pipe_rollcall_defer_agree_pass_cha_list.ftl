...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="table_4_blue">
  <tr>
	<th width="98%" height="22">隐患治理验收审批列表</th>
  </tr>
</table>
<div class="menu">
	<div style="float:left;">
  	<ul>
	<li id="img_left"></li>
	<li id="img_amend"><a href="javascript:loadNote('loadRollcallDeferAgreeForPassCha.xhtml?rollcallDefer.id');" class="b2"><b>查看</b></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap><a href="loadRollcallDeferAgreeForPassCha.xhtml?rollcallDefer.id=${r.id}"><div align="center">在${r.createTime?string('yyyy年MM月dd日')}提交验收申请。</div></a></td>
    ...
    <td><div align="center"><#if r.done?exists&&r.done><#if r.isAgree?exists&&r.isAgree!=2><#if r.isAgree?exists&&r.isAgree==1>同意隐患治理验收申请。
    	<#else>不同意隐患治理验收申请；${r.remark}。</#if></#if></#if>&nbsp;</div></td>
  </tr>
  </#list>
  </#if>
</table>
