...
<div class="menu">
	<div style="float:left;">
  	<ul>
	<li id="img_left"></li>
	<li id="img_amend"><a href="javascript:loadNote('loadRollcallDeferAgreeForPass.xhtml?rollcallDefer.id');" class="b2"><b>审批</b></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    ...
    <td nowrap><a href="loadRollcallDeferAgreeForPass.xhtml?rollcallDefer.id=${r.id}"><div align="center">在${r.createTime?string('yyyy年MM月dd日')}提交验收申请。</div></a></td>
