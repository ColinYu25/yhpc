...
<table width="700" border="1" cellpadding="0" cellspacing="0">
	<tr height="80" style="font-size:18px;line-height:25px;">
	  ...
	  <td colspan="3" align="left" style="vertical-align:bottom;">&nbsp;${danger.pipeLine.daPipelineCompanyinfo.company.companyName}<p>
	  　　　　　　　　　　　　　　　　　　　　　　　　　（盖章）</td>
	  </tr>
	  <tr height="40" style="font-size:18px;line-height:25px;vertical-align:middle;">
	  <th>所在区域</th>
	  <td colspan="3" align="left">&nbsp;<#if danger.secondArea?exists><#if danger.secondArea!=0><script type="text/javascript">document.write(areaObj.getArea("${danger.secondArea}")[0]);</script></#if></#if>
	  <#if danger.thirdArea?exists><#if danger.thirdArea!=0><script type="text/javascript">document.write(areaObj.getArea("${danger.thirdArea}")[0]);</script></#if></#if>&nbsp;</td>
	  </tr>
	  <tr>
	<tr height="40" style="font-size:18px;line-height:25px;vertical-align:middle;">
	  <th>联 系 人</th>
...
<input type="hidden" name="rollcallDefer.daPipeRollcallCompany.id" value="${rollcallCompany.id}">
