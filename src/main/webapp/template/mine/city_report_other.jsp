    ...
    <tr>
	  ...
	  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr style="font-size:12px">
		  ...
		  </select>年<select id="month" name="mineReport.month" style="width:45px;" onChange="window.location='loadCityReportInit.xhtml?mineReport.type=2&mineReport.year='+get('year').value+'&mineReport.month='+this.value;">
