...
<form action="loadBags.xhtml" method="post" name="bagsForm" id="bagsForm">
...
<div class="menu">
  	<ul>
  	<li id="img_save">		<a href="createBagInit.xhtml" class="b1"><b>添加</b></a></li>
  	<li id="img_amend">		<a href="#" class="b2" onClick="loadNote('loadBag.xhtml?bag.id');"><b>修改</b></a></li>
  	<li id="img_del">		<a href="#" class="b3" onClick="deleteNote(get('bagForm'));"><b>删除</b></a></li>
