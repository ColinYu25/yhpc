...
<form action="loadBagCompanies.xhtml?bagId=${bagId}" method="post" name="companyForm" id="companyForm">
...
<div class="menu">
  	<ul>
  	<li id="img_xcjcjl">		<a href="#" class="b_xcjcjl" onClick="dabao()"><b>更换包</b></a></li>
  	<li id="img_xcjcjl">		<a href="#" class="b_xcjcjl" onClick="deleteNote(get('bagCompanyRelForm'));"><b>取消打包</b></a></li>
	<li id="img_refurbish">	<a href="#" class="b4" onClick="window.location.reload();"><b>刷新</b></a></li>
	<li id="img_return">	<a href="javascript:history.go(-1);" class="b6"><b>返回</b></a></li>
	</ul>
</div>
<form action="${contextPath}/bagCompanyRel/deleteBagCompanyRel.xhtml" method="post" name="bagCompanyRelForm" id="bagCompanyRelForm">
