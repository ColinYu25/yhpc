        ...
        <tr>
		  ...
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_list">
            ...
            <tr id="row${status.count-1}">
              ...
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="wuzheng_${status.count-1}" value="${details[status.count-1].wuzheng}" name="details[${status.count-1}].wuzheng"  class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"  readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="guanbi_${status.count-1}" value="${details[status.count-1].guanbi}" name="details[${status.count-1}].guanbi" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="tingchan_${status.count-1}" value="${details[status.count-1].tingchan}" name="details[${status.count-1}].tingchan" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)"readonly /></td>
			  <td align="center" ><input type="text" style="IME-MODE:disabled;" id="manbao_${status.count-1}" value="${details[status.count-1].manbao}" name="details[${status.count-1}].manbao" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="jubuzhixing_${status.count-1}" value="${details[status.count-1].jubuzhixing}" name="details[${status.count-1}].jubuzhixing" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="feifayonggong_${status.count-1}" value="${details[status.count-1].feifayonggong}" name="details[${status.count-1}].feifayonggong" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="zuoyeguicheng_${status.count-1}" value="${details[status.count-1].zuoyeguicheng}" name="details[${status.count-1}].zuoyeguicheng" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="gongyi_${status.count-1}" value="${details[status.count-1].gongyi}" name="details[${status.count-1}].gongyi" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="zhidubujianquan_${status.count-1}" value="${details[status.count-1].zhidubujianquan}" name="details[${status.count-1}].zhidubujianquan" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="zhongda_${status.count-1}" value="${details[status.count-1].zhongda}" name="details[${status.count-1}].zhongda" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="yingji_${status.count-1}" value="${details[status.count-1].yingji}" name="details[${status.count-1}].yingji" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="xincailiao_${status.count-1}" value="${details[status.count-1].xincailiao}" name="details[${status.count-1}].xincailiao" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
              <td align="center" ><input type="text" style="IME-MODE:disabled;" id="qita_${status.count-1}" value="${details[status.count-1].qita}" name="details[${status.count-1}].qita" class="input" maxlength="8" size="4" onchange="calculate(this,1)" onKeyDown="checkNumber(this,1)" readonly /></td>
            </tr>
			</c:forEach>
