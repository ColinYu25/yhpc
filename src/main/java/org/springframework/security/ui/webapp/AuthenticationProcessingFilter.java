...
public class AuthenticationProcessingFilter extends AbstractProcessingFilter {
    ...
    public static final String SPRING_SECURITY_FORM_LONG_KEY = "j_login";
    public static final String SPRING_SECURITY_LAST_USERNAME_KEY = "SPRING_SECURITY_LAST_USERNAME";

    private String usernameParameter = SPRING_SECURITY_FORM_USERNAME_KEY;
    private String passwordParameter = SPRING_SECURITY_FORM_PASSWORD_KEY;
    private String loginParameter = SPRING_SECURITY_FORM_LONG_KEY;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request) throws AuthenticationException {
        ...
        String loginkey =  obtainLogin(request);
        if (username == null) {
            username = "";
        }
        ...
        UsernamePasswordAuthenticationToken authRequest = new UsernamePasswordAuthenticationToken(username, password,loginkey);
