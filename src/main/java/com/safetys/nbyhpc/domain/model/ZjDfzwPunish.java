 ...
 * @version 1.0.0
 */
public class ZjDfzwPunish extends DaBaseModel {
	...
	private boolean isAnweiCheck = false;
	
	/**报表类型：1：周报；2：月报*/
	private Integer reportType;

	private Set<ZjDfzwPunishDetail> dfzwPunishDetails = new HashSet<ZjDfzwPunishDetail>(0);

	private String anweiBackState="0";//安委会是否退回标志，默认为“0”不可以退回；“1”可以退回
	public ZjDfzwPunish() {
	}

	public ZjDfzwPunish(Long id) {
		super(id);
	}
	...
	public Set<ZjDfzwPunishDetail> getDfzwPunishDetails() {
		return dfzwPunishDetails;
	}

	public void setDfzwPunishDetails(Set<ZjDfzwPunishDetail> dfzwPunishDetails) {
		this.dfzwPunishDetails = dfzwPunishDetails;
	}
