 ...
 * @version 1.0.0
 */
public class ZjDfzwReportDetail extends DaBaseModel {

	private static final long serialVersionUID = -5003193015650463596L;

	private ZjDfzwReport dfzwReport;
	...
	public ZjDfzwReportDetail() {
	}

	public ZjDfzwReportDetail(Long id) {
		super(id);
	}

	public ZjDfzwReportDetail(String type, Integer wuzheng, Integer guanbi, Integer tingchan, Integer manbao,
	...
	public void addDfzwReportDetail(Integer wuzheng, Integer guanbi, Integer tingchan, Integer manbao,
			Integer jubuzhixing, Integer feifayonggong, Integer zuoyeguicheng, Integer gongyi, Integer zhidubujianquan,
			Integer zhongda, Integer yingji, Integer xincailiao, Integer qita) {
		this.wuzheng += wuzheng;
		this.guanbi += guanbi;
	...
	public ZjDfzwReport getDfzwReport() {
		return dfzwReport;
	}

	public void setDfzwReport(ZjDfzwReport dfzwReport) {
		this.dfzwReport = dfzwReport;
	}
