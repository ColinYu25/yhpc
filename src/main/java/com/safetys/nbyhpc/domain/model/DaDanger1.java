 ...
 * 
 */
public class DaDanger1 extends DaBaseModel {
	...
	private Set<DaDangerGorver1> daDangerGorvers1 = new HashSet<DaDangerGorver1>(0);

	private Set<DaRollcallCompany1> daRollcallCompanies1 = new HashSet<DaRollcallCompany1>(0);

	private Set<DaIndustryParameterHis> daIndustryParametersHis = new HashSet<DaIndustryParameterHis>(0);
	...
	private DaDangerGorver1 daDangerGorver1;//lisl 列表显示计划治理和治理隐患
	...
	public Set<DaDangerGorver1> getDaDangerGorvers1() {
		return daDangerGorvers1;
	}

	public void setDaDangerGorvers1(Set<DaDangerGorver1> daDangerGorvers1) {
		this.daDangerGorvers1 = daDangerGorvers1;
	}

	public Set<DaRollcallCompany1> getDaRollcallCompanies1() {
		return daRollcallCompanies1;
	}

	public void setDaRollcallCompanies1(Set<DaRollcallCompany1> daRollcallCompanies1) {
		this.daRollcallCompanies1 = daRollcallCompanies1;
	}

	public Set<DaIndustryParameterHis> getDaIndustryParametersHis() {
		return daIndustryParametersHis;
	}

	public void setDaIndustryParametersHis(Set<DaIndustryParameterHis> daIndustryParametersHis) {
		this.daIndustryParametersHis = daIndustryParametersHis;
	}
	 ...
	 * @param trades
	 */
	public void setIndustryParametersHis(String trades) {
		industryParameters = trades;
		if (trades != null && !"".equals(trades)) {
			for (String trade : trades.split(",")) {
				if (Long.parseLong(trade.trim()) != -1L) {
					boolean exists = false;
					for (DaIndustryParameterHis industry : daIndustryParametersHis) {
						if (industry.getId() == Long.parseLong(trade.trim())) {
							exists = true;
						}
					}
					if (!exists) {
						daIndustryParametersHis.add(new DaIndustryParameterHis(Long.parseLong(trade.trim())));
					}
				}
			}
		}
	...
	public DaDangerGorver1 getDaDangerGorver1() {
		return daDangerGorver1;
	}

	public void setDaDangerGorver1(DaDangerGorver1 daDangerGorver1) {
		this.daDangerGorver1 = daDangerGorver1;
	}

	public void setIndustryParameters(String industryParameters) {
